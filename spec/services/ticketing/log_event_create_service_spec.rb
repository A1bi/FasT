...
RSpec.describe Ticketing::LogEventCreateService do
  ...
  shared_examples 'creates a log event for web orders only' do |event|
    context 'with a web order' do
      ...
      it_behaves_like 'creates a log event', event
    end
  ...
  describe '#create' do
    ...
    it_behaves_like 'creates a log event', :created
  end
  ...
  describe '#redeem' do
    ...
    it_behaves_like 'creates a log event', :redeemed
  end
  ...
  describe '#send' do
    ...
    it_behaves_like 'creates a log event', :sent do
      let(:info) { params }
    end
  end
  ...
  describe '#resend_confirmation' do
    ...
    it_behaves_like 'creates a log event for web orders only',
                    :resent_confirmation
  end
  ...
  describe '#resend_items' do
    ...
    it_behaves_like 'creates a log event for web orders only', :resent_items
  end
  ...
  describe '#cancel_tickets' do
    ...
    context 'without a reason' do
      it_behaves_like 'creates a log event', :cancelled_tickets_without_reason do
        let(:info) { { count: order.tickets.count } }
      end
    end
    ...
    context 'with a cancellation at box office' do
      ...
      it_behaves_like 'creates a log event', :cancelled_tickets_at_box_office do
        let(:info) { { count: order.tickets.count } }
      end
    end
  end
  ...
  describe '#transfer_tickets' do
    ...
    it_behaves_like 'creates a log event', :transferred_tickets do
      let(:info) { { count: order.tickets.count } }
    end
    ...
    context 'with a transfer by customer' do
      ...
      it_behaves_like 'creates a log event', :transferred_tickets_by_customer do
        let(:info) { { count: order.tickets.count } }
      end
    end
  end
  ...
  describe '#enable_resale_for_tickets' do
    ...
    it_behaves_like 'creates a log event', :enabled_resale_for_tickets do
      let(:info) { { count: order.tickets.count } }
    end
  end
end
